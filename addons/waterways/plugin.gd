...
func _show_river_control_panel() -> void:
	...
	_connect_once(menu, "debug_view_changed", Callable(self, "_on_debug_view_changed"))
...
func _hide_river_control_panel() -> void:
	...
	_disconnect_if_connected(menu, "debug_view_changed", Callable(self, "_on_debug_view_changed"))
